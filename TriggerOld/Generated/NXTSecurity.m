...
@implementation NXTSecurity
	...
	+ (NXTSecurity*) serviceWithUsername: (NSString*) username andPassword: (NSString*) password {
		return [[[NXTSecurity alloc] initWithUsername:username andPassword:password] autorelease];
	}

		
	/* Returns NXTTicket*. Used to create a Login Ticket to an NXT System */
	...
	- (SoapRequest*) login: (id) _target action: (SEL) _action Company: (NSString*) Company UserName: (NSString*) UserName Password: (NSString*) Password
		...
		[_params addObject: [[[SoapParameter alloc] initWithValue: Company forName: @"Company"] autorelease]];
		...
		SoapRequest* _request = [SoapRequest create: _target action: _action service: self soapAction: @"http://www.dccusa.com/NxtApi/login" postData: _envelope deserializeTo: [[NXTTicket alloc] autorelease]];
		[_request send];
		return _request;
	}

	/* Returns NXTTicket*. Used to create a Login Ticket to an NXT System if password has not expired. */
	...
	- (SoapRequest*) loginWithPasswordExpirationCheck: (id) _target action: (SEL) _action Company: (NSString*) Company UserName: (NSString*) UserName Password: (NSString*) Password
		...
		SoapRequest* _request = [SoapRequest create: _target action: _action service: self soapAction: @"http://www.dccusa.com/NxtApi/loginWithPasswordExpirationCheck" postData: _envelope deserializeTo: [[NXTTicket alloc] autorelease]];
		[_request send];
		return _request;
	}
	...
	- (SoapRequest*) loginWithIDs: (id) _target action: (SEL) _action companyID: (NSString*) companyID userID: (NSString*) userID PIN: (NSString*) PIN
		...
		[_params addObject: [[[SoapParameter alloc] initWithValue: PIN forName: @"PIN"] autorelease]];
		...
		SoapRequest* _request = [SoapRequest create: _target action: _action service: self soapAction: @"http://www.dccusa.com/NxtApi/loginWithIDs" postData: _envelope deserializeTo: [[NXTTicket alloc] autorelease]];
		[_request send];
		return _request;
	}

	/* Returns NXTTicket*. Used to create a Login Ticket to an NXT System after changing an expired password */
	...
	- (SoapRequest*) ChangeLoginPassword: (id) _target action: (SEL) _action Company: (NSString*) Company UserName: (NSString*) UserName CurrentPassword: (NSString*) CurrentPassword NewPassword: (NSString*) NewPassword
		...
		[_params addObject: [[[SoapParameter alloc] initWithValue: Company forName: @"Company"] autorelease]];
		[_params addObject: [[[SoapParameter alloc] initWithValue: UserName forName: @"UserName"] autorelease]];
		[_params addObject: [[[SoapParameter alloc] initWithValue: CurrentPassword forName: @"CurrentPassword"] autorelease]];
		...
		SoapRequest* _request = [SoapRequest create: _target action: _action service: self soapAction: @"http://www.dccusa.com/NxtApi/ChangeLoginPassword" postData: _envelope deserializeTo: [[NXTTicket alloc] autorelease]];
		[_request send];
		return _request;
	}

	/* Returns NXTSecurityUser*. Return Security User for the Referenced Ticket */
	...
	- (SoapRequest*) returnSecurityUser: (id) _target action: (SEL) _action TicketID: (NSString*) TicketID
		...
		[_params addObject: [[[SoapParameter alloc] initWithValue: TicketID forName: @"TicketID"] autorelease]];
		...
		SoapRequest* _request = [SoapRequest create: _target action: _action service: self soapAction: @"http://www.dccusa.com/NxtApi/returnSecurityUser" postData: _envelope deserializeTo: [[NXTSecurityUser alloc] autorelease]];
		[_request send];
		return _request;
	}

	/* Returns BOOL. Used to invalidate a Ticket created with Login */
	...
	- (SoapRequest*) logout: (id) _target action: (SEL) _action tick: (NXTTicket*) tick
		...
		[_params addObject: [[[SoapParameter alloc] initWithValue: tick forName: @"tick"] autorelease]];
	...
	/* Returns NSString*. Return the Version being used on this system. */
